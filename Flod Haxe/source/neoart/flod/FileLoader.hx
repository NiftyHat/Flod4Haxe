...
final class FileLoader
{
	...
	public var tracker(get, never):String;

	function get_tracker():String
	{
		return (player != null) ? TRACKERS[index + player.version] : TRACKERS[0];
	}
	...
	public function load(stream:ByteArray):CorePlayer
	{
		...
		if (player != null && !Std.isOfType(player, STPlayer))
		{
			player.load(stream);
			if (player.version != 0)
				return player;
	...
	static inline final SOUNDTRACKER = 0;
	static inline final NOISETRACKER = 4;
	static inline final PROTRACKER = 9;
	static inline final HISMASTER = 12;
	static inline final SOUNDFX = 13;
	static inline final BPSOUNDMON = 17;
	static inline final DELTAMUSIC = 20;
	static inline final DIGITALMUG = 22;
	static inline final FUTURECOMP = 24;
	static inline final SIDMON = 26;
	static inline final WHITTAKER = 28;
	static inline final FREDED = 29;
	static inline final HIPPEL = 30;
	static inline final HUBBARD = 32;
	static inline final FASTTRACKER = 33;
	static final TRACKERS:Array<String> = [
		"Unknown Format", "Ultimate SoundTracker", "D.O.C. SoundTracker 9", "Master SoundTracker", "D.O.C. SoundTracker 2.0/2.2", "SoundTracker 2.3",
		"SoundTracker 2.4", "NoiseTracker 1.0", "NoiseTracker 1.1", "NoiseTracker 2.0", "ProTracker 1.0", "ProTracker 1.1/2.1", "ProTracker 1.2/2.0",
		"His Master's NoiseTracker", "SoundFX 1.0/1.7", "SoundFX 1.8", "SoundFX 1.945", "SoundFX 1.994/2.0", "BP SoundMon V1", "BP SoundMon V2",
		"BP SoundMon V3", "Delta Music 1.0", "Delta Music 2.0", "Digital Mugician", "Digital Mugician 7 Voices", "Future Composer 1.0/1.3",
		"Future Composer 1.4", "SidMon 1.0", "SidMon 2.0", "David Whittaker", "FredEd", "Jochen Hippel", "Jochen Hippel COSO", "Rob Hubbard", "FastTracker II",
		"Sk@leTracker", "MadTracker 2.0", "MilkyTracker", "DigiBooster Pro 2.18", "OpenMPT"
	];
}
