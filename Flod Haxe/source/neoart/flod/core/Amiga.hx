...
@:allow(neoart.flod.core) 
    override function fast(e:SampleDataEvent) {
      var chan:AmigaChannel, data= e.data, i:Int, lvol:Float, mixed = 0, mixLen:Int, mixPos = 0, rvol:Float, sample:Sample, size= bufferSize, speed:Float, toMix:Int, value:Float;
