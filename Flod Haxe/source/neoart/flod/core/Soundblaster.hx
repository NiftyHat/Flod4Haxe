...
@:allow(neoart.flod.core) 
    override function fast(e:SampleDataEvent) {
      var chan:SBChannel, d:Vector<Float>, data= e.data, i:Int, mixed = 0, mixLen:Int, mixPos = 0, s:SBSample, sample:Sample, size= bufferSize, toMix:Int, value:Float;
...
@:allow(neoart.flod.core) 
    override function accurate(e:SampleDataEvent) {
      var chan:SBChannel, d1:Vector<Float>, d2:Vector<Float> = null, data= e.data, delta:Int, i:Int, mixed = 0, mixLen:Int, mixPos = 0, mixValue:Float, s1:SBSample, s2:SBSample, sample:Sample, size= bufferSize, toMix:Int, value:Float;
