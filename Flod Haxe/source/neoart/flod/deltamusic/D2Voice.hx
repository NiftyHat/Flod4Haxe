...
package neoart.flod.deltamusic ;
  import neoart.flod.core.*;
   ...
   final class D2Voice {
    ...
    @:allow(neoart.flod.deltamusic) var next           : D2Voice;
    @:allow(neoart.flod.deltamusic) var channel        : AmigaChannel;
    @:allow(neoart.flod.deltamusic) var sample         : D2Sample;
    @:allow(neoart.flod.deltamusic) var trackPtr       : Int = 0;
    @:allow(neoart.flod.deltamusic) var trackPos       : Int = 0;
    @:allow(neoart.flod.deltamusic) var trackLen       : Int = 0;
    @:allow(neoart.flod.deltamusic) var patternPos     : Int = 0;
    @:allow(neoart.flod.deltamusic) var restart        : Int = 0;
    ...
    @:allow(neoart.flod.deltamusic) var finalPeriod    : Int = 0;
    @:allow(neoart.flod.deltamusic) var arpeggioPtr    : Int = 0;
    ...
    @:allow(neoart.flod.deltamusic) var vibratoSustain : Int = 0;
    @:allow(neoart.flod.deltamusic) var volume         : Int = 0;
    @:allow(neoart.flod.deltamusic) var volumeMax      : Int = 0;
    @:allow(neoart.flod.deltamusic) var volumePos      : Int = 0;
    @:allow(neoart.flod.deltamusic) var volumeSustain  : Int = 0;
