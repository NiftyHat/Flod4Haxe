  ...
  import neoart.flod.core.*;
   ...
   final class JHPlayer extends AmigaPlayer {
        ...
        while (voice != null) {
          ...
          if (coso != 0) {
              ...
              do {
                ...
                do {
                  ...
                  if (value == -1) {
                    ...
                    if ((voice.info & 224) != 0) voice.infoPrev = stream.readByte();
                    ...
                    if (value >= 0) {
                      ...
                      if (value != -128) {
                        if (variant > 1 && ((voice.info & 64) != 0)) value = voice.infoPrev;
            ...
            if ((value & 127) != 0) {
              ...
              if (voice.patternPos == 0) stream.position += patternLen;
              stream.position -= 2;
    ...
    override function loader(stream:ByteArray) {
      ...
      base = periods = 0;
      coso = ASCompat.toInt(stream.readMultiByte(4, CorePlayer.ENCODING) == "COSO");

      if (coso != 0) {
        for (_tmp_ in 0...7) {i = _tmp_;
value += stream.readInt();
        ...
        if (id == 0 || base == 0 || periods == 0) return;
        version = 1;
...
++i;
    ...
    final
      PERIODS : Vector<Int> = Vector.ofArray([
